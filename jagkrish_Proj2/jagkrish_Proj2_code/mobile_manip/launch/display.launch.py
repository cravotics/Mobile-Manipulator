...
def generate_launch_description():
    ...
    ####### DATA INPUT ##########
    urdf_file = 'mobile_manip.urdf'
    xacro_file = "mobile_manip.urdf.xacro"
    #xacro_file = "box_bot.xacro"
    package_description = "mobile_manip"
    use_urdf = False
    ...
    default_rviz_config_path = PathJoinSubstitution(
        [FindPackageShare("mobile_manip"), "rviz", "display_default.rviz"]
    )
